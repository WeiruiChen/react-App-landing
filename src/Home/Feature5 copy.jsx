...
class Content7 extends React.Component {
  ...
  // const tabsHtml =  <Tabs tabPosition="left" key="trans_left"></Tabs>
  getBlockChildren = (item, i) => {
    ...
    // );
          return ( <Tabs tabPosition="left" key={"trans_left"+Math.random(300)}>{panlePile}</Tabs>);
  };
